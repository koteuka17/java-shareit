...
class ItemControllerTest {
    ...
    void saveNewItem() throws Exception {
        when(itemService.createItemDto(anyLong(), any())).thenReturn(itemDtoOut);
    ...
    void updateItem() throws Exception {
        when(itemService.updateItemDto(anyLong(), any(), anyLong())).thenReturn(itemDtoOut);
    ...
    void getItemById() throws Exception {
        when(itemService.getItemDto(anyLong(), anyLong())).thenReturn(itemDtoOut);
    ...
    void getItemsByOwner() throws Exception {
        when(itemService.getItemsDto(anyLong())).thenReturn(List.of(itemDtoOut));
    ...
    void getItemBySearch() throws Exception {
        when(itemService.searchItem(anyLong(), anyString())).thenReturn(List.of(itemDtoOut));
    ...
    void saveNewComment() throws Exception {
        ...
        when(itemService.createCommentDto(anyLong(), anyLong(), any())).thenReturn(commentDtoOut);
